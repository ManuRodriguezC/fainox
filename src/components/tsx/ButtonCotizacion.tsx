...
export default function ButtonCotizacion({ name, size }: Props) {
  ...
  if (size === "S") {
    return (
      <button
        ...
        className="w-8 h-8 bg-white border-2 border-red-700 rounded-lg flex justify-center items-center text-red-700">
