...
export default function ProductForLists({name, description, images}: Product) {
    return (
        <div
            className={`w-full md:w-[400px] min-h-[600px] max-h-[600px] flex flex-col gap-4 mb-10 backgroundProduct px-4 rounded-md
            ...
            <div className="w-full flex flex-col gap-5 mb-5">
                ...
                <a href={`/producto/${name}`} className="w-[220px] px-4 md:px-0 text-xl text-left font-bold text-colorBlue line-clamp-3">
                    {name}
                </a>
