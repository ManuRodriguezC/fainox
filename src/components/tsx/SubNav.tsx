        ...
        <nav className="w-full h-auto mt-10">
            <ul className="flex flex-row bg-colorBlue rounded-none md:rounded-lg pt-2 justify-center items-center md:gap-6">
                <li className="flex justify-center items-center">
                    <button
                        className={`text-xs md:text-base xl:text-xl py-4 px-1 transition-all duration-150 ${filter === "" ? "bg-white text-black rounded-higt" : "text-white font-semibold"}`}
                ...
                </li>
                {
                    subIndustrys[indus].map((sub: DatesIndustrys) => {
                        return (
                            <li>
                                <button
                                    className={`text-sss md:text-base xl:text-xl py-3 md:p-4 transition-all duration-150
