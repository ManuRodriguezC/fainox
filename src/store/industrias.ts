...
export const sectores = [
    {
      ...
      lines: ["Equipos para Leche", "Equipos para Yogurt", "Equipos para Quesos", "Equipos para Mantequilla", "Equipos Derivados Varios"],
      imagesProducts: ["/products/7.webp", "/products/8.webp", "/products/15.webp"]
    },
    {
    ...
    },
    {
        ...
        backgraund: "bg-custom-gradient",
        lines: ["Aceites y Margarinas", "Harinas y Cereales", "Carnicos y Embutidos"],
          imagesProducts: ["/products/7.webp", "/products/8.webp", "/products/15.webp"]
    }
  ]