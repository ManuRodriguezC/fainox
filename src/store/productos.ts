export const productos = [
    ...
    {
        "name": "Sistema de bombeo para Pasta Hilado",
        "industry": ["Lacteos y Derivados"],
        "product": ["lacteos-y-derivados"],        
        "subIndustry": "equipos para quesos",
