  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "image-0": "url('/industrys/milk.webp')",
        "image-1": "url('/industrys/milk.webp')",
        "image-2": "url('/industrys/salsas.webp')",
        "image-3": "url('/industrys/aceites.webp')",
      },
      screens: {
        custom: "1555px",
      },
