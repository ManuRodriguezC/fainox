...
import 'kleur/colors';
import { c as capitalize, $ as $$LayoutPage, p as productos$1 } from '../../chunks/LayoutPage_B5C4cmgW.mjs';
...
const $$ProductoForList = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div${addAttribute(`w-[400px] min-h-[600px] max-h-[600px] flex flex-col gap-4 mb-10 backgroundProduct px-4 rounded-md
