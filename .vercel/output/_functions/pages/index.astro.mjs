/* empty css                                    */
import { c as createComponent, r as renderTemplate, m as maybeRenderHead, d as addAttribute, a as renderComponent } from '../chunks/astro/server_CRNezd4r.mjs';
import 'kleur/colors';
import { d as sectores, $ as $$LayoutPage } from '../chunks/LayoutPage_CHO-jBof.mjs';
...
const $$About = createComponent(($$result, $$props, $$slots) => {
  const services = [
    {
      name: "Proyectos",
      description: "En Fainox Group S.A.S. desarrollamos proyectos industriales especializados para los sectores de l\xE1cteos, conservas, aceites y alimentos varios, ofreciendo soluciones a medida para cada fase de producci\xF3n.",
      image: "proyectos.webp",
    ...
    {
      name: "Fabricaci\xF3n",
      description: "Nuestros procesos de fabricaci\xF3n estamos en enfoc\xE1ndonos en calidad, durabilidad y cumplimiento de normas de inocuidad de los equipos.",
      image: "fabricacion1.webp",
      classDiv: "relative group bg-gray-400 row-span-1 rounded-xl col-span-2 hover:shadow-box-black",
      classImage: "w-full h-full lg:h-[340px] object-cover object-bottom rounded-xl brightness-75 group-hover:brightness-50 transition-all duration-200",
      info: true
    },
    {
      ...
      description: "",
      image: "logo.png",
      classDiv: "flex flex-col justify-center item-center row-start-2 row-end-4 col-start-2 col-end-4",
      classImage: "w-auto rounded-xl",
      info: false
    },
    {
      name: "Automatizaci\xF3n & Control",
      description: "Nuestros sistemas de control, basados en tecnolog\xEDas de vanguardia, permiten monitorear y ajustar en tiempo real los par\xE1metros de producci\xF3n, asegurando una operaci\xF3n eficiente y conforme a los est\xE1ndares de calidad y seguridad alimentaria.",
    ...
    },
    {
      ...
      description: "Nuestros programas est\xE1n dise\xF1ados para optimizar el uso de equipos, sistemas de automatizaci\xF3n y procesos productivos, asegurando que el personal adquiera las habilidades necesarias para operar con eficiencia y seguridad.",
      image: "ofi2.jpg",
      classDiv: "relative group rounded-xl bg-gray-400 row-start-4 col-start-2 col-end-4 hover:shadow-box-black",
      classImage: "w-full h-full lg:h-[340px] object-cover rounded-xl brightness-75 group-hover:brightness-50 transition-all duration-200",
      info: true
    },
    {
      name: "Montajes",
      description: "Nuestros procesos de fabricaci\xF3n utilizan tecnolog\xEDa avanzada para producir soluciones robustas y adaptadas a cada cliente, enfoc\xE1ndonos en precisi\xF3n, durabilidad y cumplimiento de normas sanitarias. Garantizamos calidad y seguridad alimentaria mediante un riguroso control en cada fase del proceso.",
      image: "montajes.webp",
    ...
    },
    {
      ...
      description: "Nuestro equipo de ingenieros altamente capacitados brinda asistencia t\xE9cnica integral, que incluye diagn\xF3stico avanzado, calibraci\xF3n de equipos y resoluci\xF3n de problemas en tiempo real. Implementamos programas de mantenimiento preventivo y correctivo.",
      image: "soporte.webp",
...
</p> </div> <div class="w-[80%] lg:w-[33%] h-auto flex justify-center items-center md:showImage mb-4"> <img class="w-auto h-[300px] md:h-[400px] rounded-round-image1" src="/images/logogris.webp" alt="Fainox Group - Quienes Somos"> </div> </div> <div class="w-full h-auto flex flex-col lg:flex-row justify-between items-center bg-custom-blue px-6 py-20 md:p-20"> <div class="w-[80%] lg:w-[33%] h-auto showImage2"> <img class="w-full h-[300px] md:h-[600px] object-cover rounded-round-image2" src="/images/que-proponemos.webp" alt="Fainox Group - Quienes Somos"> </div> <div class="w-full lg:w-[60%] seeContent text-white"> <h2 class="font-bold text-xl lg:text-2xl xl:text-5xl text-white mb-4 md:mb-10">Que Proponemos</h2> <p class="text-balance text-xs md:text-sm lg:text-base xl:text-md whitespace-normal text-justify tracking-wide leading-5 md:leading-6 lg:leading-10">
...
</p> </div> </div> <div class="w-full h-auto flex flex-col-reverse lg:flex-row md:mt-12 px-5 md:px-16 lg:px-32 justify-between items-center"> <div class="w-full lg:w-[60%] p-6 md:px-0 seeContent text-justify"> <h2 class="font-bold text-xl lg:text-2xl xl:text-5xl text-colorBlue mb-4 md:mb-10">
Como lo Hacemos
</h2> <p class="text-base md:text-base xl:text-lg text-black font-bold whitespace-normal tracking-wide leading-7 md:leading-6 lg:leading-10 mb-6">
...
</p> <ul class="list-disc flex flex-col gap-3 text-sm md:text-md xl:text-base"> <li>
...
</li> </ul> </div> <div class="w-[80%] lg:w-[35%] h-auto showImage"> <img class="w-full h-[300px] md:h-[600px] object-cover rounded-round-image3" src="/images/como.webp" alt="Fainox Group - Quienes Somos"> </div> </div> </section>`;
}, "/home/manurodriguez/fainox/src/components/fainox.astro", undefined);

function BannerLoop() {
  return /* @__PURE__ */ jsx("section", { className: "w-full h-[40vh] md:h-[77vh]", children: /* @__PURE__ */ jsx(
    Swiper,
    {
      slidesPerView: 1,
      spaceBetween: 4,
            ...
            /* @__PURE__ */ jsx(
              "a",
              {
                ...
                children: /* @__PURE__ */ jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsx("p", { className: "text-xs md:text-xl lg:text-2xl text-justify font-light py-5", children: sector.description }),
                  /* @__PURE__ */ jsx("ul", { className: "text-xs md:text-xl lg:text-base xl:text-2xl p-3 md:p-10 flex flex-wrap justify-between items-center gap-2 md:gap-10 list-disc", children: sector.lines.map((line) => /* @__PURE__ */ jsx("li", { className: "font-semibold md:font-bold", children: line }, line)) })
                ] })
              }
            )
          ] })
...
}, "/home/manurodriguez/fainox/src/pages/index.astro", undefined);
